        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5>Please fill below information per to passport</h5><br>

                        <form method="POST" action="{{ route('guestreqs.passportInfo', [$guestReqId]) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="" id="firstnameError" style="color: red; font-size:12px"></label>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="birthdate" class="col-md-2 col-form-label text-md-left">Date of Birth</label>
                                <div class="col-md-6">
                                    <input id="birthdate" type="date" class="form-control" name="birthdate"
                                        value="" autocomplete="birthdate" autofocus>
                                    <label for="" id="birthdateError" style="color: red; font-size:12px"></label>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="" id="birth_placeError" style="color: red; font-size:12px;"></label>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="issue_date" class="col-md-2 col-form-label text-md-left">Issue Date</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="expiry_date" class="col-md-2 col-form-label text-md-left">Expiry Date</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="profession" class="col-md-2 col-form-label text-md-left">Profession</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="visa_status" class="col-md-2 col-form-label text-md-left">Visa Status</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="withcompanion" class="col-md-4 col-form-label text-md-left">Are you Traveling
                                    with companion (plus one)?</label>
                                <div class="col-md-4">
                                    <select class="form-control" name="withcompanion" id="withcompanion"
                                        data-select-search="true" required>
                                        <option value=""></option>
                                        <option value="0">No</option>
                                        <option value="1">Yes</option>
                                    </select>
                                    <label for="" id="withcompanionError"
                                        style="color: red; font-size:12px;"></label>
                                </div>
                            </div>
